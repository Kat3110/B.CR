  ...
  datasets: [
    {
      ...
      lineTension: 0.3,
      data: [
        33, 23, 25, 21, 24, 15, 33, 23, 35, 21, 34, 26, 20, 33, 11, 30, 37, 24,
        33, 31, 15, 14, 20, 15, 24, 18, 36, 35, 16, 37, 32,
      ],
      fill: true,
    ...
    },
    {
      ...
      lineTension: 0.3,
      data: [
        33, 15, 35, 21, 14, 26, 13, 35, 21, 34, 36, 20, 15, 24, 18, 36, 27, 14,
        17, 25, 34, 16, 35, 10, 13, 33, 16, 20, 34, 20, 30,
      ],
      fill: false,
      borderColor: "#FFD702",
    },
    {
      ...
      lineTension: 0.3,
      data: [
        33, 25, 25, 11, 24, 36, 10, 15, 31, 21, 17, 30, 25, 13, 28, 26, 17, 34,
        27, 35, 14, 26, 15, 19, 15, 33, 11, 20, 34, 10, 32,
      ],
      fill: false,
      borderColor: "#00E99E",
    },
    ...
    <>
      <div className="chart-insight__menu">
        <div className="chart-insight__button-group">
          <div className="chart-insight__button chart-insight__button-active">
            Day
          </div>
