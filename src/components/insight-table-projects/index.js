...
import {ReactComponent as ArrowUpLeft} from "../../assets/ArrowUUpLeftGray.svg";
import {ReactComponent as ArrowElbowLeft} from "../../assets/ArrowElbowLeftGray.svg";
import {ReactComponent as TrendUp} from "../../assets/TrendUpGray.svg";
import {ReactComponent as TrendDown} from "../../assets/TrendDownGray.svg";
    ...
    return (
        <div className='insight-table'>
            <div className='insight-table__btn-group'>
                <Button color='black' icon={<ArrowUpLeft />} text='Fastest response time' />
                <Button icon={<ArrowElbowLeft />} text='Fastest response time' />
                <Button icon={<TrendUp />} text='Largest data amount' />
                <Button icon={<TrendDown />}  text='Smallest data amount' />
            </div>
            <TableContainer>
